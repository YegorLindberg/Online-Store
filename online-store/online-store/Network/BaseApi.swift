...
class BaseApi {
    ...
    func sendRequest(relativeUrl: String, params: [String: Any]?, handler: @escaping (Any) -> Void) {
        ...
        let resultParams = prepareParams(params: params, absoluteUrl: &absoluteUrl) //Add app key here
    ...
    func prepareParams(params: [String: Any]?, absoluteUrl: inout String) -> [String: Any]? {
